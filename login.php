...
<div style="display: flex; justify-content: center;" class="form-center">
	...
	<form action="/petrunev/login_system/signin.php" method="post">
		<p>
		...
		<p>
			<div style="font-weight: Bold; font-family: sans-serif;">У вас нет аккаунта? - <a href="/petrunev/register.php">Зарегистрируйтесь!</a></div>
		</p>
		<p>
