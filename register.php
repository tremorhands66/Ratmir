...
<div style="display: flex; justify-content: center;" class="form-center">
	<form class="form-reg" action="/petrunev/login_system/registration.php" method="POST">
		...
		<button type="submit" class="btn3">Зарегистрироваться</button>
				<p>
					<div style="font-weight: Bold; font-family: sans-serif;">У вас уже есть аккаунта? - <a href="/petrunev/login.php">Авторизируйтесь!</a></div>
                </p>
                <p>
					<div style="font-weight: Bold; font-family: sans-serif;">Хочешь вернустья ?- <a href="/petrunev/index.php">На главную!</a></div>
				</p>
